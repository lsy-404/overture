...
const checks: Array<[string, boolean]> = [
  ...
  ["confirmation UI discloses widget configuration and destination", ["turnstiles", "turnstileRecipeWarning", "turnstileSecretWorker", "widget.secret.target === 'recipe'", "widget.secret.name"].every((needle) => read("src/components/steps/StepConfirm.vue").includes(needle))],
